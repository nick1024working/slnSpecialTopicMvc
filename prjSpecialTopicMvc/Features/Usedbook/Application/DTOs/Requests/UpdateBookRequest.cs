...
namespace prjSpecialTopicMvc.Features.Usedbook.Application.DTOs.Requests
{
    public class UpdateBookRequest
    {
        ...
        [StringLength(100, ErrorMessage = "書名不可超過 50 字")]
        public string Title { get; set; } = string.Empty;

        [Display(Name = "作者")]
        [Required(ErrorMessage = "作者為必填欄位")]
        [StringLength(200, ErrorMessage = "作者不可超過 100 字")]
        ...
        [Display(Name = "版次／刷次")]
        [StringLength(20, ErrorMessage = "版次／刷次不可超過 20 字")]
        public string? Edition { get; set; }

        [Display(Name = "出版社")]
        [StringLength(100, ErrorMessage = "出版社不可超過 50 字")]
